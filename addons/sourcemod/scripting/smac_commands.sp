...
Handle
	g_hBlockedCmds = INVALID_HANDLE,
	g_hIgnoredCmds = INVALID_HANDLE;
int
	g_iCmdSpamLimit             = 30,
	g_iCmdCount[MAXPLAYERS + 1] = { 0, ... };
ConVar
	g_hCvarCmdSpam    = null,
	g_hCvarCmdSpmKick = null;
...
public Action Command_Say(int client, const char[] command, int args)
{
	...
	for (int i = 0; i < iLen; i++)
	{
		...
		if (sChar == ' ')
		{
			if (iSpaceNum++ >= 64)
			{
				CPrintToChat(client, "%t", "SMAC_SayBlock");
				return Plugin_Stop;
			}
		}
...
public Action Command_BlockEntExploit(int client, const char[] command, int args)
{
	...
	if (StrContains(sArgString, "admin") != -1 || StrContains(sArgString, "alias", false) != -1 || StrContains(sArgString, "logic_auto") != -1 || StrContains(sArgString, "logic_autosave") != -1 || StrContains(sArgString, "logic_branch") != -1 || StrContains(sArgString, "logic_case") != -1 || StrContains(sArgString, "logic_collision_pair") != -1 || StrContains(sArgString, "logic_compareto") != -1 || StrContains(sArgString, "logic_lineto") != -1 || StrContains(sArgString, "logic_measure_movement") != -1 || StrContains(sArgString, "logic_multicompare") != -1 || StrContains(sArgString, "logic_navigation") != -1 || StrContains(sArgString, "logic_relay") != -1 || StrContains(sArgString, "logic_timer") != -1 || StrContains(sArgString, "ma_") != -1 || StrContains(sArgString, "meta") != -1 || StrContains(sArgString, "mp_", false) != -1 || StrContains(sArgString, "point_clientcommand") != -1 || StrContains(sArgString, "point_servercommand") != -1 || StrContains(sArgString, "quit", false) != -1 || StrContains(sArgString, "quti") != -1 || StrContains(sArgString, "rcon", false) != -1 || StrContains(sArgString, "restart", false) != -1 || StrContains(sArgString, "sm") != -1 || StrContains(sArgString, "sv_", false) != -1 || StrContains(sArgString, "taketimer") != -1)
	{
		return Plugin_Stop;
	}
